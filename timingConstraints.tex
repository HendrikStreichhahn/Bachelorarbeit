...
\subsection{TADL2-Timing Constraints}
	...
	\subsubsection{BurstConstraint}
		...
		\end{math}\\[10pt]
		 ...
		 In \ref{fig:BurstConstraintExample} the \emph{BurstConstraint} with the attributes $length=5$, $maxOccurrences=3$, $minimum=0.8$ and $event = \{1,2,3,7,8,9\}$ is visualized. %TODO weiter ausführen!!!
 		\begin{figure}
		 	\begin{tikzpicture}[thick]
			 	% time axis
			 	\foreach \y in {-2}{
